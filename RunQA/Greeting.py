...
greeing_dict = {
    ...
    'boastful': ["我可厉害了",
                 ...
                 "Listen, that's neat and all, but look how fast I can calculate this math problem: 12345 * 67890 = " + str(12345 * 67890) + ". Didn't even break a sweat.",
...
def greeting(method):
    if method in greeing_dict.keys():
        return choice(greeing_dict[method])
    else:
        return "Sorry programer made a mistake!"
